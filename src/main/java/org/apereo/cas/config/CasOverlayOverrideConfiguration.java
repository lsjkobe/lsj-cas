...
import org.apereo.cas.config.custom.auth.configuration.CasConfiguration;
...
@Import({CasConfiguration.class, FlowConfiguration.class, CasWebflowExecutionConfiguration.class})
